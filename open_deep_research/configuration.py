...
class Configuration:
    ...
    supervisor_model: str = "groq:llama3-70b-8192" # Model for supervisor agent in multi-agent setup
    researcher_model: str = "groq:llama3-70b-8192" # Model for research agents in multi-agent setup 
